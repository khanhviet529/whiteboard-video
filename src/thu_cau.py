"""Thu NHIEU cach dien dat cho cung mot y, roi nghe va do de chon.
    ...
    python src/thu_cau.py build/thu_cau.txt --engine voicestudio --voice namtre_v3
...
# `_in_contour` da bo cung duong WSL: no in he so toc do ma `speak.contour_for`
# ap cho TUNG cau (cau cuoi x0,95). /generate chi nhan MOT `speed` cho ca lan
# goi, khong co contour theo vi tri - in ra thi thanh so lieu sai su that.
